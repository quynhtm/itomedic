    ...
    <div class="news-right">
        ...
        <div class="noi_dung_kham">
            <div class="col-md-12">
                <div class="main_ndk">
                    <div class="col-md-11">
                        <i class="fa fa-2x fa-check myicon"></i>
                        <span>Điều dưỡng và nâng cao sức khỏe</span>
                    </div>
                    <div class="col-md-1 text-right myicon">
                        <i class="fa fa-3x fa-angle-down" data-toggle="collapse" data-target="#demo"></i>
                    </div>
            ...
            <div class="col-md-12">
                <div class="main_ndk">
                    ...
                    <div class="col-md-1 text-right myicon">
                        <i class="fa fa-3x fa-angle-down" data-toggle="collapse" data-target="#demo1"></i>
                    </div>
                    <div class="clearfix"></div>
            ...
            <div class="col-md-12">
                <div class="main_ndk">
                    ...
                    <div class="col-md-1 text-right myicon">
                        <i class="fa fa-3x fa-angle-down" data-toggle="collapse" data-target="#demo2"></i>
                    </div>
                    <div class="clearfix"></div>
            ...
            <div class="col-md-12">
                <div class="main_ndk">
                    ...
                    <div class="col-md-1 text-right myicon">
                        <i class="fa fa-3x fa-angle-down" data-toggle="collapse" data-target="#demo3"></i>
                    </div>
                    <div class="clearfix"></div>
            ...
            <div class="col-md-12">
                <div class="main_ndk">
                    ...
                    <div class="col-md-1 text-right myicon">
                        <i class="fa fa-3x fa-angle-down" data-toggle="collapse" data-target="#demo4"></i>
                    </div>
                    <div class="clearfix"></div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                                <div class="thumbnail">
                                    ...
                                    <div>
                                        ...
                                        <div class="read_more text-center" style="display: block;">
                                            <a href="#">
...
<div class="stats_test">
    <div class="col_md_12 stats">
        ...
        <div class="doi_tac">
            <div class="col-md-12 content_doitac ">
                <div class="col-md-2">
                    <a href="#">
