...
class CGlobal
{
    ...
    const code_shop_share = 'Manager Itomedic';
    const web_name = 'Manager Itomedic';
    const web_keywords = 'Manager Itomedic';
    const web_description = 'Manager Itomedic';
    public static $pageTitle = 'Manager Itomedic';
